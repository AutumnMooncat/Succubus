...
public class LateLosePowerPower extends AbstractEasyPower {
    ...
    public LateLosePowerPower(AbstractCreature owner, AbstractPower powerToLose, int amount) {
        super(strings.NAME + powerToLose.name, PowerType.DEBUFF, false, owner, amount);
        this.ID = LateLosePowerPower.TEXT_ID+powerToLose.name;
