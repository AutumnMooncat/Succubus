package Succubus.cards.abstracts;

import Succubus.MainModfile;
import Succubus.TheSuccubus;
import Succubus.util.CardArtRoller;
...
import static Succubus.MainModfile.makeImagePath;
import static Succubus.MainModfile.modID;
import static Succubus.util.Wiz.atb;
import static Succubus.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheSuccubus.Enums.SUCCUBUS_ROSE_COLOR);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.SUCCUBUS_ROSE_COLOR.cpy()));
